...
const build = series(clean, dev, parallel(markup, style, script, video, image, svg, font, localization));
const deploy = series(clean, prod, parallel(markup, style, script, video, image, svg, font, localization), archive);
const development = series(clean, dev, parallel(markup, style, script, video, image, svg, font, localization), serve);
